...
return [
    ...
    */
    ...
    'providers' => ServiceProvider::defaultProviders()
        ->replace([
            Illuminate\Auth\AuthServiceProvider::class         => App\Providers\AuthServiceProvider::class,
            Illuminate\Bus\BusServiceProvider::class           => App\Providers\BusServiceProvider::class,
